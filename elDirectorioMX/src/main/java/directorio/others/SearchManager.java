...
public class SearchManager {
	 ...
	 */
	public static ArrayList<Advertiser> negociosenRango(double latitude,	double longitude, double rangoBuscar, String ciudad,String filtroString, String pais) {
        //Reemplazamos el espacio dentro del nombre del pais por %20 para que no haya problema con las consultas.
	...
	public static ArrayList<Advertiser> returnAll(String filtro, String pais) {
        ...
        //quitamos los espacions tambien en el nombre del pais para que no haya problemas con las consultas.
        pais = pais.replace(" ","%20");
